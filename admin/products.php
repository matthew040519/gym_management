                ...
                <div class="card">
                  <div class="card-header">
                      <button
                            ...
                            >
                            <i class='bx bx-user-plus' ></i> Add Products
                    </button>
                  </div>
                  <div class="card-body">
            ...
            <?php
              ...
              if(isset($_POST['submit'])) {
                  ...
                  if (move_uploaded_file($_FILES['image']['tmp_name'], $target)){
                    mysqli_query($con, "INSERT INTO products (`product_name`, `product_image`, `product_details`, `price`) VALUES ('$product_name', '$image', '$details', '$product_price')");
