         ...
         <?php include('../include/navbar.php'); ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Listing /</span> Rates</h4>
                <div class="card">
                  <div class="card-header">
                      <button
                            ...
                            >
                            <i class='bx bx-user-plus' ></i> Add Rates
                    </button>
                  </div>
                  <div class="card-body">
                        <table id="example" class="table table-striped nowrap" style="width:100%">
                          ...
                          <tbody>
                              <?php
                              $query = mysqli_query($con, "SELECT * FROM rates");
