                              ...
                              <div class="row">
                                ...
                                <div class="demo-inline-spacing mt-3">
                                    ...
                                    <?php
                                        ...
                                        INNER JOIN instructor_skills ON instructor.id=instructor_skills.instructor_id
                                        INNER JOIN instructor_types ON instructor_types.id=instructor_skills.type_id
                                        WHERE instructor.id = '$id'");
                                        while($row = mysqli_fetch_array($query)){
                                    ?>
                                    <li class="list-group-item"><?php echo $row['types']; ?></li>
                                    <?php } ?>
                                    </ol>
                                </div>
                                </div>
