          ...
          <div class="content-wrapper">
                          ...
                          <div class="card-body">
                            <form method="POST">
                              ...
                              <div class="mb-3 col-md-12">
                                  <label for="lastName" class="form-label">Bio</label>
                                  <textarea name="bio" rows="8" class="form-control" id=""><?php echo $row['biography']; ?></textarea>
                                </div>
                                <div class="mb-3 col-md-12">
                                ...
                                <div class="mb-3 col-md-6">
                                  ...
                                  <input class="form-control" type="text" name="contact_number" id="lastName" value="<?php echo $row['contact']; ?>" />
                                </div>
                                <div class="mb-3 col-md-12">
                                  <label for="lastName" class="form-label">Address</label>
                                  <textarea name="address" class="form-control" id=""><?php echo $row['address']; ?></textarea>
                                </div>
            ...
            <?php
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $queryInsert = mysqli_query($con, "UPDATE instructor SET `fullname`= '$fullname', `biography` = '$bio', `address` = '$address', `contact` = '$contact_number' WHERE id = '$id'");
                                if($queryInsert)
                                {
