          ...
          <div class="content-wrapper">
                            ...
                            <form method="POST">
                              ...
                              <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                  ...
                                  <input class="form-control" type="text" name="contact_number" id="lastName" value="<?php echo $row['contact_number']; ?>" />
                                </div>
                                <div class="mb-3 col-md-12">
            ...
            <?php
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $queryInsert = mysqli_query($con, "UPDATE member SET `fullname`= '$fullname', `address` = '$address', `contact_number` = '$contact_number' WHERE id = '$id'");
                                if($queryInsert)
                                {
